...
async def root(item: Item):
    if item.condicion=='2':
        ...
        respuesta3=0
        respuesta3={
              "cups_codigo":tablas_enc2['cups_codigo'].inverse_transform([[prediccion[0][0]]])[0][0],
              "cups_codigo_probabilidad":max(clf11.predict_proba([dato_en])[0][0]),
              "descripcion" :tablas_enc2['descripcion'].inverse_transform([[prediccion[0][1]]])[0][0],
              "descripcion_probabilidad":max(clf11.predict_proba([dato_en])[1][0]),
              "cantidad":tablas_enc2['cantidad'].inverse_transform([[prediccion[0][2]]])[0][0],
              "cantidad_probabilidad":max(clf11.predict_proba([dato_en])[2][0]),
              "prescripcion": tablas_enc2['prescripcion'].inverse_transform([[prediccion[0][3]]])[0][0][0][0],
              "prescripcion_probabilidad":max(clf11.predict_proba([dato_en])[3][0]),
              "tipo": tablas_enc2['tipo'].inverse_transform([[prediccion[0][4]]])[0][0],
              "tipo_probabilidad":max(clf11.predict_proba([dato_en])[4][0]),
              "codigo_medicamento":tablas_enc2['codigo_medicamento'].inverse_transform([[prediccion2[0][0]]])[0][0],
              "codigo_medicamento_probabilidad":max(clf22.predict_proba(lists)[0][0]),
              "descripcion_medicamento":tablas_enc2['descripcion_medicamento'].inverse_transform([[prediccion2[0][1]]])[0][0],
              "descripcion_medicamento_probabilidad":max(clf22.predict_proba(lists)[1][0]),
              "cantidad_medicamento":tablas_enc2['cantidad_medicamento'].inverse_transform([[prediccion2[0][2]]])[0][0],
              "cantidad_medicamento_probabilidad":max(clf22.predict_proba(lists)[2][0]),
              "prescripcion_medicamento":tablas_enc2['prescripcion_medicamento'].inverse_transform([[prediccion2[0][3]]])[0][0],
